...
## GPT-2 large: 36-layer, 1280-hidden, 20-heads, 774M parameters.
#SIZE=large
#MODEL=gpt2-$SIZE
#BS=1
...
# TRAINING COMMAND
#----------------------------------------------------------------
python -W ignore -u -m torch.distributed.launch --nproc_per_node=8 --nnodes=1 --node_rank=0 tools/run_language_modeling.py \
        --model_type gpt2 \
